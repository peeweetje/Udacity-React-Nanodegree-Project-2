...
const MessageCard = ({ comment, postTitle, postCategory, postId }: MessageCardProps) => {
  ...
  return (
    <Link
      ...
      className='message-card opacity-0 block bg-card dark:bg-gray-800 rounded-xl shadow-sm border border-teal-500 dark:border-gray-700 p-4 md:p-5 hover:shadow-md hover:border-teal-400 dark:hover:border-teal-600 transition-all duration-200'
    >
