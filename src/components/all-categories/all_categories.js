...
const Categories = props => {
  ...
  const iconThumbsUp = (postId, option) => {
    props.fetchVotePost(postId, "upVote");
  };

  //Dispatches votePost action for a given postId. Option determines upvote/downvote.
  const iconThumbsDown = (postId, option) => {
    props.fetchVotePost(postId, "downVote");
  };
                        ...
                        <List.Content>
                          ...
                          <List.Content className="votes">
                            <Icon
                              ...
                              onClick={() => iconThumbsUp(post.id, "upVote")}
                              color="teal"
                              size="large"
                            />
                            ...
                            <Icon
                              ...
                              size="large"
                              onClick={() =>
                                iconThumbsDown(post.id, "downVote")
                              }
                            />
                          </List.Content>
